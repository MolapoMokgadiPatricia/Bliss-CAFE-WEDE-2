This is a simple static website built using HTML, CSS and Java Script.
...
<Key Features
    ...
    "Home","About Us", "Contact Us", "Our Menu" and "Our GAllery" sections
...
<Usage Instructions>
    ...
    Modified css/styles.css to change colors, fonts, or layout.

    Add new pages and link them through the navigation bar.

<Author>

Molapo Mokgadi Molapo 
Student Number: ST10487723
...
<Initial Release (2025-08-27)>
    ...
    Created, "About Us", "Our Contact", " Our Gallery", " Our Menu" pages
...
<Latest Update (2025-09-26)>
    ...
    Changed the design of the logo.

    Added the "View Menu" on the homepage.

    Added the "promo banner".

    Added the hamburger icon.

    Added "About Bliss Cafe" and " Testimonials" on the Homepage 
...
<Latest Update (2025-11-19)>
    ...
    Added Java script in each HTMl page.

    Improved mobile responsiveness.

    Added Timestamp and Current year feature on the footer.

    Changed the image on the promo banner.

    Added slide fade for the images in the gallery. 

    Added more media quairies for diffent devices.
...
<Improvents from feedback (2025-11-19)>
    ...
    Made more usage of pseudo selectors/classes.

    Used slide show effects for the gallery.

    Made more usage of Media Queries/Breakpoints for Tablet and Mobile.

    Each submission has its own repository. 

<Respomsiveness Evidence>

/assets/MobileRespond.png
/assets/TabletRespond.png
